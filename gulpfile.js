...
var gdoc_id = "1AyqCMyREwPfHlU8RAbSu1a22cPH-ulDkv105xQcFBpE";
var gdoc_host = "127.0.0.1:6006";
var gdoc_url = "http://"+gdoc_host+"/"+ gdoc_id;
var content = {};

var qzdataPath = process.env.QZDATA_PATH || '/Users/kcollins2/Code/qzdata';
var thingName = 'trump-kim-quiz';
var thingPath = qzdataPath + '/' + '2017/trump-kim-quiz';
    ...
    request.get({
      ...
      function(error, resp, body) {
        if(!error && resp.statusCode < 400) {
          ...
          fs.writeFileSync("src/assets/content.json",body,"utf-8");
          doneCallback();
        }
        else {
